...
GOX	EQU	STAVAR+10*2			;GRAPHIC VIEWPORT ORIGIN  X in px
GOY	EQU	STAVAR+11*2			;GRAPHIC VIEWPORT ORIGIN  Y in px
GXW	EQU	STAVAR+12*2			;GRAPHIC VIEWPORT X WIDE in px
GYH	EQU	STAVAR+13*2			;GRAPHIC VIEWPORT Y HEIGHT in px
