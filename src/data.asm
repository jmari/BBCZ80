...
;
ACCS	EQU 4A00H				;STRING ACCUMULATOR
BUFFER	EQU	4B00H				;STRING INPUT BUFFER
STAVAR	EQU	4C00H				;STATIC VARIABLES
OC		EQU	STAVAR+14*4			;CODE ORIGIN (O%)
PC		EQU	STAVAR+15*4			;PROGRAM COUNTER (P%)
DYNVAR	EQU STAVAR + 27*4  ;54*2;DYN. VARIABLE POINTERS
