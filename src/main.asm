...
;CREATE_PROC - WE WANT TO INICIALIZE WITH THE SEGMENT WHERE THE PROC IS FOUND INSTEAD SETTING TO 0
;              ANY VARIABLE CAN NOT BE PLACED IN ADDRESSES LOWER THEN 255,SO WE CAN CHECK IF THE PROC 
...
CREATE:	XOR	A
	...
	LD	(HL),A
	INC	HL
	XOR A   ;reset A, next bytes should be always 0
LOC7:	INC	IY
