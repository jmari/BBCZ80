...
;OF THE BRITISH BROADCASTING CORPORATION & IS
...
;
	...
	PUBLIC	MODIFS
	;-----------------------------------------------------------
	PUBLIC	DSRCH    ;WE USE THESE FUNCTION IN INSTALL.ASM MODULE
	PUBLIC 	CR
	PUBLIC 	TLAST
	PUBLIC 	TCMD
	PUBLIC	EXTRAS
...
CMDTAB:	DEFW	LEFTSL
	...
	DEFW	TINT
	DEFW	WAIT
	DEFW	INSTALL		;INSTALL    change syntax by install
	DEFW	REM		;CR
...
CASE5:	CALL	NXT
	...
	INC	IY
	PUSH	BC		;Save type & string length
