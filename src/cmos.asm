...
BBC:	DEFM	"BBC"
;
;HEX - Read a hex string & convert to binary.
...
;
;
;TRAP - Test ESCAPE flag & abort if set;
;       every 20th call, test for keypress.
; Destroys: A,H,L,F
;
;LTRAP - Test ESCAPE flag & abort if set.
; Destroys: A,F
;
TRAP:	LD	HL,TRPCNT
	DEC	(HL)
...
ABORT:	LD	HL,FLAGS	;ACKNOWLEDGE
	...
	JP	ESCAPE		;AND ABORT
;
;TEST - Sample for ESCape & CTRL/S. If ESCape
;       pressed set ESCAPE flag & return.
; Destroys: A,F
;
TEST20:	LD	(HL),20
TEST:	PUSH	DE
